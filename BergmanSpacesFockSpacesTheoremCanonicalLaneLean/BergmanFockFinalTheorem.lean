import BergmanSpacesFockSpacesTheoremCanonicalLaneLean.BergmanFockGate
...
theorem constrained_bergman_fock_endgame (A : AdmissibleClass) : ConstrainedBergmanFockClosure A := by
